...
namespace commands {
    ...
    class rot_cam_y : public command {
        public:
            rot_cam_y(double angle, size_t index) : angle(angle), index(index) {}
            rot_cam_y(rot_cam_y&) = delete;
            rot_cam_y(const rot_cam_y&) = delete;
            ~rot_cam_y() = default;

            virtual void execute(controller*& c) {
                camera_dimensional_transformations::rot_cam_y comm(this->angle);
    ...
    class rot_cam_x : public command {
        public:
            rot_cam_x(double angle, size_t index) : angle(angle), index(index) {}
            rot_cam_x(rot_cam_x&) = delete;
            rot_cam_x(const rot_cam_x&) = delete;
            ~rot_cam_x() = default;

            virtual void execute(controller*& c) {
                camera_dimensional_transformations::rot_cam_x comm(this->angle);
                c->transform_camera(comm, this->index);
            }
    ...
    class rot_cam_z : public command {
        public:
            rot_cam_z(double angle, size_t index) : angle(angle), index(index) {}
            rot_cam_z(rot_cam_z&) = delete;
            rot_cam_z(const rot_cam_z&) = delete;
            ~rot_cam_z() = default;

            virtual void execute(controller*& c) {
                camera_dimensional_transformations::rot_cam_z comm(this->angle);
                c->transform_camera(comm, this->index);
            }
