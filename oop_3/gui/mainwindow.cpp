...
void MainWindow::keyPressEvent(QKeyEvent* e) {
    ...
    try {
        ...
        if (e->key() == Qt::Key_W) {
            ...
            commands::rot_cam_y comm(ANGLE, camera_current_index);
            this->command_controller.execute_command(comm);
            ...
            commands::rot_cam_x comm(-ANGLE, camera_current_index);
            this->command_controller.execute_command(comm);
            ...
            commands::rot_cam_z comm(-ANGLE, camera_current_index);
            this->command_controller.execute_command(comm);
...
void MainWindow::on_pushButton_clicked()
{
    try
    {
        QString file_path = QFileDialog::getOpenFileName(this, QObject::tr("Specify file with model"),
                                                         QDir::currentPath(), QObject::tr("all (*.json *.txt)"));
